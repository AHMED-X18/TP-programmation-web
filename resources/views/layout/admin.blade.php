...
<body>
    ...
    <div class="admin-details">
        <a href="{{ route('admin.profile.edit') }}" class="admin-name-link" title="Modifier mon profil">
            @if (Auth::check())
        ...
        <div class="admin-actions-buttons">
            <a href="{{ route('admin.profile.edit') }}" class="btn-mini btn-mini-profile">
    ...
    <script src="{{ asset('js/tableau de bord.js') }}" defer></script>
    @stack('scripts')
</body>
</html>
